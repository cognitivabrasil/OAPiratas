        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          ...
          <div class="col-6">
            <div class="card" style="border:none;">
                ...
                <div id="mot_17"></div>
                <br><br>
                <div style="text-align: center;"><input type="button" value="enviar questionário" onclick="enviaPesquisa(); return false;"></div>
                </form>
            </div>
          </div>
          <div class="col align-bottom">
      ...
      <script>
        ...
        function enviaPesquisa(){
                    ...
                    $.post("sendEmail.php", {texto:texto}, function(data){
                       console.log(data);
                       alert('Questionário enviado com sucesso. Obrigado');
                    });
                };
        $(function(){
