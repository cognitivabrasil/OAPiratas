        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          <div class="col align-bottom">
            <div class="card" style="text-align:right; border:none;">
              <a href="08.php"><img class="card-img-top" src="./img/COMANDOS/01SETAVOLTAVERM.png" alt="Voltar" style="width:40%;"></a>
            </div>
          </div>
          <div class="col-6">
            <div class="card" style="border:none;">
              <img class="card-img-top" src="./img/HISTORIA/009.jpg" alt="009">
            </div>
          </div>
          <div class="col align-bottom">
            <div class="card" style="border:none;">
