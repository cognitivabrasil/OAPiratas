        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          ...
          <div class="col-6">
            <div class="card" style="border:none;">
              <img class="card-img-top" src="./img/HISTORIA/011B.jpg" alt="011B">
              <div class="col align-bottom">
          ...
          <div class="col align-bottom">
            <div class="card" style="border:none;">
              <a href="012B.php"><img class="card-img-top" src="./img/COMANDOS/01SETAAVANCAVERM.png" alt="Avançar" style="width:40%;"></a>
            </div>
          </div>
        </div>
      </div>
