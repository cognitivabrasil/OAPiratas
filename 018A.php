        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          ...
          <div class="col-6">
            <div class="card" style="border:none;">
              <img class="card-img-top" src="./img/HISTORIA/018A.jpg" alt="018A">
            </div>
          </div>
          <div class="col align-bottom">
            <div class="card" style="border:none;">
              <a href="desafio3.php"><img class="card-img-top" src="./img/COMANDOS/03VOLTARDESAFIO3.png" alt="Avançar" style="width:40%;"></a>
            </div>
          </div>
        </div>
      </div>
