        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          <div class="col align-bottom">
            <div class="card" style="text-align:right; border:none;">
              <a href="011C.php"><img class="card-img-top" src="./img/COMANDOS/01SETAVOLTAVERM.png" alt="Voltar" style="width:40%;"></a>
            </div>
          </div>
          <div class="col-6">
            <div class="card" style="border:none;">
              <img class="card-img-top" src="./img/HISTORIA/012C.jpg" alt="012C">
              <div class="col align-bottom">
                <div class="card" style="text-align:left; border:none;">
                  <div class="row">
                    <div class="col">
                      <a href="011A.php"><img class="card-img-top" src="./img/COMANDOS/04PIRATA1.png" alt="Voltar" style="width:70%;"></a>
                    </div>
                    <div class="col">
          ...
          <div class="col align-bottom">
            <div class="card" style="border:none;">
              ...
              <a href="desafio2C.php"><img class="card-img-top" src="./img/COMANDOS/03IRDESAFIO2.png" alt="Avançar" style="width:40%;"></a>
            </div>
          </div>
        </div>
      </div>
