        ...
        <div class="row vertical-align" style="display: flex; align-items: flex-end;">
          <div class="col align-bottom">
            <div class="card" style="text-align:right; border:none;">
              <a href="011B.php"><img class="card-img-top" src="./img/COMANDOS/01SETAVOLTAVERM.png" alt="Voltar" style="width:40%;"></a>
            </div>
          </div>
          <div class="col-6">
            <div class="card" style="border:none;">
              <img class="card-img-top" src="./img/HISTORIA/012B.jpg" alt="012B">
              <div class="col align-bottom">
          ...
          <div class="col align-bottom">
            <div class="card" style="border:none;">
              ...
              <a href="desafio2B.php"><img class="card-img-top" src="./img/COMANDOS/03IRDESAFIO2.png" alt="Avançar" style="width:40%;"></a>
            </div>
          </div>
        </div>
      </div>
